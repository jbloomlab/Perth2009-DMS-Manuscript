...
In addition to the data in Figure S5, we have added the following text:
...
The new Figures S5 to S7 now show the growth phenotype of other selected mutants, one of which includes a start codon mutant.
}
