...
\comment{Not sure how to address the growth phenotype question}.
...
We have therefore created a new supplemental figure (Fig.~S7) that shows these data---as the reviewer suspected, this shows that head mutations are much more common.
...
\comment{Also need to add mention of this figure in the manuscript text somewhere...}
...
However, this is the first paper to show that data from deep mutational scanning can actually provide some insight into evolutionary outcomes in nature, and it is possible that this can provide a useful framework for applying deep mutational scanning studies in the context of evolution in nature...
}
...
\comment{Fixed the figure. Still need to explain frequency}
