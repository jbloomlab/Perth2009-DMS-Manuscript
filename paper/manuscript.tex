...
The WSN/1933 H1 and the Perth/2009 H3 fall into two phylogenetically distinct groups and share 42\% amino-acid identity (Figure~\ref{fig:distance_distribution}A).
\begin{itemize}
\item Correlations are higher within homolog replicate than between homologs
\item Next aligned and compared preferences using a correction method to account for experimental noise
\end{itemize}
