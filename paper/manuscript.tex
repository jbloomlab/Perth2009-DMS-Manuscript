...
This strain was the H3N2 component of the influenza vaccine from 2010-2012~\comment{add citation}.
...
We then generated mutant virus libraries from the mutant plasmids using a helper-virus system that enables the efficient generation of complex influenza virus libraries~\citep{doud2016accurate} (Figure~\ref{fig:dms_overview}A).
...
To further increase viral titers, we used MDCK-SIAT1 cells that we had engineered to constitutively express the TMPRSS2 protease, which facilitates HA cleavage and activation~\citep{bottcher2006proteolytic, bottcher2010cleavage}.
